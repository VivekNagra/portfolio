...
function SkillGroupCard({ group, gi }) {
  ...
  return (
    <div
      ref={ref}
      className={`cursor-light reveal reveal-delay-${gi % 3} rounded-lg border border-zinc-200 bg-white p-4 ring-1 ring-[--color-brand]/15 dark:border-zinc-800 dark:bg-zinc-900/60`}
    >
